...
public sealed class AuthTokenGenerator
{
        ...
        List<Claim> userClaims = new()
    {
        ...
        JwtSecurityToken tokenOptions = new(
            ...
            claims: userClaims,
            expires: DateTime.Now.AddMinutes(_authSettingsOptionsMonitor.CurrentValue.AccessTokenLifetimeMinutes),
    ...
    {
        SymmetricSecurityKey secretKey = new(Encoding.UTF8.GetBytes(_authSettingsOptionsMonitor.CurrentValue.RefreshSecret));
        SigningCredentials signingCredentials = new(secretKey, SecurityAlgorithms.HmacSha512);
        ...
        List<Claim> userClaims = new()
    {
        ...
        JwtSecurityToken tokenOptions = new(
            ...
            audience: _authSettingsOptionsMonitor.CurrentValue.Audience,
            claims: userClaims,
            expires: DateTime.Now.AddDays(_authSettingsOptionsMonitor.CurrentValue.RefreshTokenLifetimeDays),
            signingCredentials: signingCredentials);
