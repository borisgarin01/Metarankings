        ...
        if (dataContext.Games.Count() == 0)
        {
            dataContext.AddRange([
                ...
                new Game
                {
                    ...
                    ImageSource="https://metarankings.ru/images/uploads/2021/12/demons-souls-ps5-boxart-cover.jpg",
                    LocalizationId=2,
                    Score=8.6f,
                    Description="Demon’s Souls для PS5 — это масштабный ремейк ставшей культовой игры от знаменитых японских разработчиков From Software, которая дебютировала в 2010 на PlayStation 3. Графика полностью переработана и адаптирована под 4K-разрешение, с эффектами нового поколения и трассировкой лучей. Игроков также ожидают два графических режима, которые можно будет переключать во время прохождения: повышенное разрешение или частота кадров.\r\n\r\nВ ремейке вас ожидает мастерски воссозданный с нуля мир культовой фэнтези от Хидэтака Миядзаки, полный кошмаров и окутанный жутким туманом с графикой нового поколения. Сюжет расскажет истоию о том, как лишенные души люди теряют рассудок и превращаются в пустые оболочки, которыми движет лишь желание причинить вред живым.",
                    ReleaseDate=DateTime.Parse("12 ноября 2020")
                },
                new Game
                {
                    Name="Marvel’s Spider-Man",
                    ImageSource="https://metarankings.ru/images/uploads/spider-man-box-cover-art.jpg",
                    LocalizationId=1,
                    Score=8.5f,
                    Description="В игре Marvel’s Spider-Man для PS4 от Insomniac Games вы встретитесь с самым знаменитым супергероем всех времен, который обзавелся новыми зрелищными приемами. К выдающимся акробатическим способностям, импровизации, выпусканию липкой паутины из рук и лазанью по стенам добавлено множество новых элементов, еще ни разу не появлявшихся в играх о Человеке-пауке. Беспрерывный паркур, взаимодействие с окружающими элементами, новые боевые приемы и кинематографичные моменты – такого Человека-паука вы еще никогда не видели.\r\n\r\nПоявление нового Spider-Man стало возможным благодаря объединению студии Marvel и Insomniac Games. Это уже не тот Человек-паук, которого вы встречали в других проектах и фильмах. Этот Питер Паркер, куда уже более набивший руки на борьбе с преступностью большого Нью-Йорка. Но в то же самое время, ему с трудом удается находить баланс между своей личной жизнью и карьерой, когда на его плечах лежит тяжелый груз в виде судеб девяти миллионов жителей города Нью-Йорк.",
                    ReleaseDate=DateTime.Parse("7 сентября 2018")
                },
                new Game
                {
                    Name="Uncharted 2: Among Thieves",
                    ImageSource="https://metarankings.ru/images/uploads/2009/10/uncharted-2-among-thieves-boxart-cover.jpg",
                    LocalizationId=1,
                    Score=7.9f,
                    Description="Игра Uncharted 2: Among Thieves — это вторая часть истории о приключениях Натана Дрейка от студии Naughty Dog.\r\n\r\nРеликвия, найденная на одном из кораблей Марко Поло, заставила охотника за сокровищами Натана Дрейка отправиться в экспедицию в Гималаи, на поиски легендарного камня Чинтамани. Но Дрейк далеко не единственный, кто мечтает заполучить ценный артефакт. Герою и его товарищам предстоит сделать все возможное, чтобы выжить в столкновениях с жестокими наемниками и раскрыть одну из самых мрачных тайн в истории человечества.",
                    ReleaseDate=DateTime.Parse("14 октября 2009")
                },
                new Game
                {
                    Name="Half-Life: Alyx",
                    ImageSource="https://metarankings.ru/images/uploads/half-life-alyx-box-art-cover.jpg",
                    LocalizationId=2,
                    Score=7.8f,
                    Description="Игра Half-Life: Alyx — это возвращение компании Valve в культовую вселенную Half-Life с использованием новейших технологий виртуальной реальности. Alyx рассказывает историю борьбы с жестокой расой пришельцев, известной как Альянс, а события игры развиваются между первой и второй частью серии.\r\n\r\nВы возьмете на себя роль Аликс Вэнс, и вы — единственный шанс человечества на спасение. Контроль Альянса за планетой после инцидента в Чёрной Мезе только усилился: оставшееся население согнано захватчиками в города и порабощено. Среди жителей остались и лучшие земные учёные — Аликс и ее отец, доктор Илай Вэнс.\r\n\r\nВ Alyx вы узнаете как зарождалось сопротивление и как они проводили подпольную научную деятельность — ставили важнейшие исследования и создавали инструменты для тех немногих, кто осмелился бросить вызов Альянсу.\r\n\r\nЭто флагманский проект для шлемов виртуальной реальности.",
                    ReleaseDate=DateTime.Parse("23 марта 2020")
                },
                new Game
                {
                    Name="Divinity: Original Sin 2",
                    ImageSource="https://metarankings.ru/images/uploads/Divinity-Original-Sin-2-boxart-cover.jpg",
                    LocalizationId=2,
                    Score=7.5f,
                    Description="Divinity: Original Sin 2 — это продолжение успешной изометрической ролевой игры Divinity: Original Sin, которая разрабатывалась на средства, которые были получены полученные с пожертвований геймеров на краудфандинговой площадке Kickstarter.\r\n\r\nСобытия  разворачиваются в фэнтезийном мире, которое имеет название Ривеллон. С момента событий оригинальной первой части прошло уже достаточно много лет. Маги Источника оказываются в кандалах у священного Ордена. Дабы сбежать из плена, героям предстоит собрать собственную группу из четырех непохожих друг на друга личностей, и с боем пробиться на свободу, попутно узнав о себе много нового и интересного.",
                    ReleaseDate=DateTime.Parse("14 сентября 2017")
                },
                new Game
                {
                    Name="Horizon Zero Dawn\r\n",
                    ImageSource="https://metarankings.ru/images/uploads/Horizon-Zero-Dawn-boxart-cover.jpg",
                    LocalizationId=1,
                    Score=8.0f,
                    Description="Игра Horizon Zero Dawn — это захватывающее приключение в открытом пост-апокалиптическом мире, где природа взяла свое на руинах былой цивилизации. В этом разрушенном мире, человечество больше не играет доминирующую роль, а доминируют теперь — динозавро-подобные машины (роботы) находящиеся на вершине пищевой цепочки. Вы возьмете на себя роль героини по имени Алои, молодого изгоя из человеческой общины, которые научился уничтожать эти грозные машины подручными средствами. Алои отправляется на поиски средств для окончательного уничтожения машин и освобождения Земли от их правления.\r\n\r\nПо пути, героиня столкнется с огромным разнообразием машин — некоторые безобидные обитатели стад, другие охотники, которые охотятся в одиночку и представляют большую угрозу. Вам нужно будет изучать повадки машин и узнавать их слабые места, чтобы выжить в разрушенном мире. Вы должны будете использовать окружающую среду в свою пользу (например прячась в зарослях), использовать стелс, ловкость, и хитрость, чтобы подойти к добычи незамеченным.",
                    ReleaseDate=DateTime.Parse("1 марта 2017")
                }
                ]);
