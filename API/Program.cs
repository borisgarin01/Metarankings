...
builder.Services.AddScoped<ICollectionsComponentsItemsRepository, CollectionsComponentsItemsRepository>(instance => new CollectionsComponentsItemsRepository(connectionString));
